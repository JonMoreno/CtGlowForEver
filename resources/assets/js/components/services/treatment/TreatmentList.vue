...
//------------------------------------------------------
    created: function() {
        let vi = this;
        Event.listen('onAddItem', function(item) { //NewItem.store()
        ...
        Event.listen('onSelectItem' , function(index) { //ListItem.select()
            vi.toggleSelection(index);
        });
        Event.listen('onRemoveListItem', function(index){ //ListItem.destroy()
